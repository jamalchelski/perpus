...
<head>
    ...
    <style>
    .bgg {
        background-image: url('<?php echo base_url(); ?>assets2/img/bkgsma.png');
            ...
            <nav class="teal darken-2">
                <div class="container">
                        ...
                        <div class="nav-wrapper">
                            <a href="<?php echo base_url();?>Buku" class="brand-logo"><img src="<?php echo base_url(); ?>assets2/img/Logo/ll.png" width="45px" alt=""></a>
    ...
    <div class="section no-pad-bot">
      <div class="container">
        ...
        <div class="row center">
          <img class=" responsive-img z-depth-5" width="200px" src="<?php echo base_url(); ?>assets2/img/Logo/ll.png" alt="" srcset="">
        </div>
        <h3 class="header center white-text text-lighten-5 z-depth-5">PERPUSTAKAAN ISTA AL KAMAL</h3>
       

      </div>
    </div>
    <div class="parallax"><img src="<?php echo base_url(); ?>assets2/img/bkgsma.png" alt="Unsplashed background img 1"></div>
  </div>
  <!-- Slider end -->
    ...
    <div class="content-wrapper">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    AUTHOR &copy; : <a href="#" target="_blank">WIRANGGA</a>
                </div>
